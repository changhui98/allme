...
export default function DualCtaSection() {
  return (
    <section aria-label="시작하기" className="grid gap-4 sm:grid-cols-2">
      <div className="flex flex-col items-start rounded-lg border border-stone-200 p-8 dark:border-stone-800">
      ...
      <div className="flex flex-col items-start rounded-lg border border-stone-200 p-8 dark:border-stone-800">
        ...
        <Link
          ...
          className="mt-6 rounded-md border border-stone-300 px-4 py-2.5 text-sm font-semibold text-stone-700 hover:bg-stone-100 dark:border-stone-700 dark:text-stone-200 dark:hover:bg-stone-800"
        >
          업체 등록하기
        </Link>
      </div>
