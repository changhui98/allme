 ...
 * 로고·중앙 앰비언트 심볼은 public/brand/의 SVG 자산을 쓰고,
 * 점 3개·동심원("모든 서비스가 한곳으로 모인다"는 메타포)은 CSS 장식이다.
...
export default function BrandPanel() {
  return (
    <aside className="brand-panel">
      ...
      />
      {/* 장식: 중앙 앰비언트 심볼 + 점 3개 */}
      <div aria-hidden="true" className="brand-panel__art">
        {/* eslint-disable-next-line @next/next/no-img-element -- 정적 SVG 장식, 최적화 불필요 */}
        <img
          src="/brand/symbol-outline-ambient.svg"
          alt=""
          className="brand-panel__art-symbol"
        />
        <span className="brand-panel__art-dots">
      ...
      <div className="brand-panel__content">
        <Link href="/" className="brand-panel__logo" aria-label="올미 홈">
          ...
          <img
            src="/brand/logo-allme.svg"
            alt="올미(allme)"
            className="brand-panel__logo-img"
          />
        </Link>
